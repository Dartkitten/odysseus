...
On first setup, Odysseus prompts the user to create the admin account. If
`ODYSSEUS_ADMIN_USER` is set, a temporary password will be printed in the terminal.
